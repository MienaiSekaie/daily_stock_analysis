...
class Config:
    ...
    # Color scheme: True = green-up/red-down (international), False = red-up/green-down (A-share convention)
    green_up_red_down: bool = True
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            green_up_red_down=os.getenv('GREEN_UP_RED_DOWN', 'true').lower() == 'true',
